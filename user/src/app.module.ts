...
@Module({  
  imports: [
    ...
    UserModule,
    // MongooseModule.forRoot('mongodb+srv://milanl:DwdeE2Ox4OONB8r8@cluster0.wthgtfo.mongodb.net/authdb', {
    //   connectionName: 'authdb',
    // }),
    // MongooseModule.forRoot('mongodb+srv://milanl:DwdeE2Ox4OONB8r8@cluster0.wthgtfo.mongodb.net/chatdb', {
